...
const NAV = [
  ...
  { href: '/admin/enquiries', label: 'Enquiries', icon: '📬', exact: false, children: undefined },
  { href: '/admin/calendar', label: 'Calendar', icon: '📅', exact: false, children: undefined },
  { href: '/admin/blockouts', label: 'Blockouts', icon: '🚫', exact: false, children: undefined },
  { href: '/admin/customers', label: 'Customers', icon: '👥', exact: false, children: undefined },
