...
export default function DriverLoginForm({ portalName, siteName }: { portalName: string; siteName: string }) {
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex w-[400px] bg-slate flex-col justify-between p-10 flex-shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-display font-extrabold text-[15px] text-white tracking-tight">DriveMaster</span>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-white/60 text-[13.5px]">
            ...
            <li>✓ Add internal notes to trips</li>
            <li>✓ Send messages to the team</li>
          </ul>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-[#f0efe9] p-8">
        <div className="w-full max-w-[380px]">
          <div className="mb-8">
            ...
            <p className="text-[14px] text-ink-3 mt-1">Driver portal access</p>
          </div>
