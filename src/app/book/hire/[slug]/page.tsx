  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-border h-[56px] flex items-center px-3 gap-2">
        <Link href="/book/hire" className="p-2 -ml-1 text-ink-2 hover:text-ink transition-colors flex-shrink-0">
      ...
      <div className="px-4 pt-5 pb-10 flex-1 bg-bg">
        <BookingPanel vehicle={vehicle} availability={availability} vehicleBasePath="/book/hire" hireAgreementClauses={hireAgreementClauses} />
      </div>
    </div>
  )
}
