...
const COPY = {
  ...
  maintenance: {
    ...
    leftBody: "This site is currently under maintenance. We're sorry for the inconvenience, but we should be back shortly. For enquiries, please call 0488 838 442 or email admin@ckb.services.",
